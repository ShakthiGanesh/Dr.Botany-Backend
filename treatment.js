const treatment = [
    ...
    },
    {
        ...
        impact:
            "Late blight is one of the world's worst plant diseases, despite efforts to control it for 150 years. It causes large losses in yields of tomatoes (and potatoes), and requires the application of expensive fungicides to maintain control. Since the 1990s, a second strain (A2) has appeared in Europe, presumably and introduction from Mexico. Previously only one strain (A1) was known in Europe. There is now the potential for new strains of the oomycete through sexual reproduction, and these may be more aggressive, and/or tolerant to fungicides than those present previously. The A2 strain has spread to many countries, with the result that there are new strains that are more aggressive, produce more spores and have increased tolerance to fungicides.",
        detection:
            "Look for spots and patches on the leaves which grow rapidly and produce a furry white growth on the underside. Look for the white growth after putting the leaves in a plastic bag overnight. Check tomato plants regularly for infections, especially when the days are cool and wet, or overcast with heavy dews or mists.",
        cure:
            "Ideally, use a preventative spray before symptoms are seen, e.g., a copper product, chlorothalonil, or mancozeb. If using a systemic product, e.g., metalaxyl, cymoxanil, or dimethomorth, or a strobilurin, alternate single sprays with two sprays of a preventative product. Also, note that in some countries mancozeb is not used on fruit if growers harvest two or more times a week as the preharvest interval is 5 days (i.e., the time between the last spray and harvest). In addition, phosphorous acid has a direct and indirect effect on oomycetes, and should be tested. The indirect effect comes from its ability to stimulate plants' natural defense response against attacks by pathogens.",
        medicine: "chlorothalonil",
    },
    {
        disease: "Tomato_Leaf_Mold",
        impact:
            "The fungus causes a serious disease in cooler, wetter areas. The loss of leaves, from the bottom of the plant upwards, is rapid. Yield reduction is related to the time of infection. If plants are infected before fruits are formed, considerable crop loss occurs. In severe cases, the flowers and, occasionally, the fruit are attacked. Infected flowers may fail to set fruit. Occasionally, the fungus causes an internal blackening of the fruit. Note, in Samoa, fruit yields of susceptible varieties were tripled when fungicides were used to control the disease. In Solomon Islands, it is an important disease in the highlands. It is less common in coastal areas where another leaf mould disease occurs on tomatoes called black leaf mould, Pseudocercospora fuligena",
        detection:
            "Look for the yellow spots and rapidly developing irregular patches on the upper surfaces of the lower leaves, with brown to green areas on the under surface. Look for plants where leaves dry up and die rapidly. Note, there is another disease that has similar symptoms. It is called tomato black leaf mould, caused by the fungus, Pseudocercospora fuligena. This fungus and Passalora fulva can only be distinguished by looking at their spores under a microscope.",
        cure:
    ...
    },
    {
        ...
        impact:
            "The mosaic virus is a parasite that destroys plants, gardens, and crops down to their molecular level. Once a plant contracts the mosaic virus, the infected plant can then spread the virus to other plants and even affect an entire harvest if left untreated. Mosaic viruses affect a wide variety of horticultural and vegetable crops — roses, beans, tobacco, tomatoes, potatoes, cucumbers, pumpkins, squash, melons, and peppers.",
        detection:
            "The leaves are mottled with yellow, white, and light and dark green spots, which appear to be elevated. This gives the leaves a blister-like appearance. Plants are often stunted, or they grow poorly. Plants may have other deformities and their leaves may be crinkled or wavy. ",
        cure:
            "There are no cures for viral diseases, such as the mosaic virus, once a plant is infected. Fungicides will NOT treat this viral disease. Plant resistant varieties when available or purchase transplants from a reputable source. Do NOT save seeds from infected crops. Spot treat with least-toxic, natural pest control products, such as Safer Soap, Bon-Neem, and diatomaceous earth, to reduce the number of disease-carrying insects",
        medicine: "Safer Soap",
    },
    {
        disease: "Tomato_YellowLeaf_Curl_Virus",
        impact:
            "Tomato yellow leaf curl virus is undoubtedly one of the most damaging pathogens of tomato, and it limits production of tomato in many tropical and subtropical areas of the world.  Fruit production is dramatically reduced, particularly when plants are infected at an early age, and it is not uncommon for losses of 100% to be experienced in fields with heavily infected plants.",
        detection:
            "Infected tomato plants initially show stunted and erect or upright plant growth; plants infected at an early stage of growth will show severe stunting. However, the most diagnostic symptoms are those in leaves. Leaves of infected plants are small and curl upward; and show strong crumpling and interveinal and marginal yellowing. The internodes of infected plants become shortened and, together with the stunted growth, plants often take on a bushy appearance, which is sometimes referred to as 'bonsai' or broccoli'-like growth. Flowers formed on infected plants commonly do not develop and fall off (abscise).",
        cure:
    ...
    //potato
    {
        ...
        cure:
            "Use a preventative spray of a contact fungicide before symptoms are seen, e.g., a copper product, chlorothalonil, mancozeb or polyram. If using a systemic product that may control the disease after infection, e.g., metalaxyl, cymoxanil, dimethomorph, or a strobilurin, alternate single sprays with two sprays of a preventative product to avoid the development of resistant strains of late blight. Manufacturers of cymoxanil and dimethomorph recommend the addition of either mancozeb or polyram to these products. It is very important to follow manufacturers recommendations if using systemic products. Copper fungicides - copper hydroxide and copper sulfate - can be used on organic crops, although because of copper toxicity, alternatives, such as phosphorous acid and horticultural oils may be necessary. The frequency of spray application will depend on the susceptibility of the potato variety and whether environmental conditions favour late blight disease. ",
        medicine: "chlorothalonil",
    },
    {
    ...
    //cotton
    {
        ...
        impact:
            "Bacterial blight in cotton, also known as seedling blight, angular leaf spot, and boll rot, is caused by Xanthomonas citri pv. malvacearum (formerly referred to as Xanthomonas campestris pv. malvacearum and Xanthomonas malvacearum). In the 1940s and 1950s, bacterial blight caused severe damage throughout cotton-growing areas until the release of resistant cotton cultivars starting in 1955. The severity of this disease is greatly influenced by environmental conditions as the disease thrives in extremely warm, humid environments, which some regions are experiencing this growing season.",
        detection:
            "Bacterial blight infections can affect any above-ground portions of the plant and at any point of plant development. Lesions associated with Xanthamonas begin as an angular leaf spot with a red to brown border. Tissues surrounding lesions may also become yellow, giving the appearance of a 'halo' surrounding the lesion. The angular appearance of lesions is due to restriction of the lesion by fine veins of the cotton leaf, and bacteria may spread along the leaf veins causing blackened lesions along major veins. Leaf petioles and stems may also become infected (cotton black leg), which can lead to premature defoliation of the plant. Black cankers on stems or branches may girdle the plant causing the portions to die above the canker. Additionally, a white waxy crust containing the bacterium may also form on old leaf spots or cankers.",
        cure:
            "Delint the cotton seeds with concentrated sulphuric acid at 100ml/kg of seed. Treat the delinted seeds with carboxin or oxycarboxin at 2 g/kg or soak the seeds in 1000 ppm Streptomycin sulphate overnight. Remove and destory the infected plant debris. Rogue out the volunteer cotton plants and weed hosts. Follow crop rotation with non-host crops. Early thinning and early earthing up with potash. Grow resistant varieties like Sujatha, 1412 and CRH 71. Spray with Streptomycin sulphate +Tetracycline mixture 100g along with Copper oxychloride at 1.25 Kg/ha.",
        medicine: "Streptomycin sulphate +Tetracycline mixture",
    },
    {
        disease: "Curl virus",
        impact:
            " Cotton leaf curl virus attack had an adverse effect on the plant height of all the susceptible lines/cultivars of cotton. A decrease of 31.8 % in the height (Av. of all lines/cultivars) of diseased plants was recorded compared with those of healthy plants.",
        detection:
        ...
        medicine: "imadacloprid",
    },
    {
        disease: "Fussarium wilt",
        impact:
    ...
    //corn
    {
        disease: "Corn_Blight",
        impact:
            "Northern corn leaf blight (NCLB), caused by the fungus Exserohilum turcicum, is an increasingly important disease in the U.S. Corn Belt. The disease has appeared annually in Indiana, and has increased in prevalence since the mid- to late 2000s. NCLB can cause yield loss if it develops before or during the tasseling and silking phases of corn development. ",
        detection:
    ...
    },
    {
        ...
        cure:
            "Fungicides containing pyraclostrobin and metconazole are available for in-season gray leaf spot management. It is important to remember that a fungi-cide application is an additional cost to corn production, so growers must consider economic factors (corn market price and fungicide application cost) and other disease factors before deciding whether to apply a fungicide to manage gray leaf spot.",
        medicine: "pyraclostrobin and metconazole fungicide",
    },
    //Banana
    {
        disease: "Cordana",
    ...
    },
    {
        ...
        impact:
            "Pestalotiopsis palmarum is the causative agent of a fungal disease of bananas, coconut and Date palms . Unlike other leaf spot and blight diseases, Pestalotiopsis palmarun attacks all parts of the leaf from the base to the tip. Whereas most diseases only infect the leaf blade or the leaf petiole.",
        detection:
            "The first symptoms of Pestalotiopsis palmarum begin as very small yellow, brown or black discoloration of the leaves. The disease can be restricted to the leaf blade or may only appear on the petiole and rachis right away. Spots and discoloration areas can be smaller than 0.25 inches (6.4 mm) in size, but under optimal conditions can grow much larger eventually forming lesions. The spots will often turn a grayish color and will be outlined in black.",
        cure:
            "Based on the amount of disease on the leaves, pruning the leaves may treat the disease, but one needs to decide if pruning the leaves is worth the nutrient deficiency that could follow depending on the growth stage of the plant. Fungicides (like Bavistin, Copper oxychloride, Mancozeb and Topsin M) are also available for managing the disease, but alone will not solve the problem. Fungicides will prevent infection of healthy leaves, but infected leaves will stay infected until the leaf dies.",
        medicine: "Copper oxychloride fungicide",
    },
    {
        disease: "Sigatoka",
        impact:
            "Black sigatoka is a leaf-spot disease of banana plants caused by the ascomycete fungus Mycosphaerella fijiensis (Morelet). Also known as black leaf streak, it was discovered in 1963 and named for its similarities with yellow SigatokaPlants with leaves damaged by the disease may have up to 50% lower yield of fruit, and control can take up to 50 sprays a year.",
        detection:
            "Black Sigatoka is also known as black leaf streak. The pathogen Mycosphaerella fijiensis causes streaks that run parallel to the leaves.In the early stages of the infection of the plant, the lesions have a rusty brown appearance and appear to be faint, paint-like specks on the leaves. They become more visible on the undersides of the banana leaf as the lesions and leaves grow. The spots on the undersides of leaf are the fungus itself. The sign of the pathogen consists of the ascocarp which holds the ascospores used for dissemination to infect healthy new plants when the environment is conducive. ",
        cure:
            "Management mainly involves chemical control using fungicides like copper oxychloride, mancozeb, chlorothalonil or carbendazim at the prescribed dosage. Fungicide spraying on the foliage and pseudostem should be commenced with the initial appearance and repeated at two weeks’ interval. Use of the different fungicides in rotation will reduce the risk of resistance development in the pathogen to the systemic chemicals.",
        medicine: "Copper oxychloride fungicide",
    },
    //Rice
    {
    ...
    },
    {
        ...
        cure:
            "Avoid over fertilizing the field. Close plant spacing results in greater leaf densities that can tolerate higher hispa numbers.Leaf tip containing blotch mines should be destroyed. Manual collection and killing of beetles – hand nets.To prevent egg laying of the pests, the shoot tips can be cut. Clipping and burying shoots in the mud can reduce grub populations by 75 - 92%. Reduviid bug eats upon the adults. Spraying of methyl parathion 0.05% or Quinalphos 0.05%.",
        medicine: "Pesticide",
    },
    {
        disease: "LeafBlast",
        ...
        detection:
            "Above ground parts of the rice plant (leaves,  nodes and neck) are attacked by the fungus. Initial symptoms are white to gray-green lesions or spots with brown border.Small specks originate on leaves - subsequently enlarge into spindle shaped spots (0.5  to 1.5 cm length and 0.3 to 0.5 cm width) with ashy center.Older lesions are elliptical or spindle-shaped and whitish to gray with necrotic borders. Several spots coalesce to form big irregular patches. Nodal infection causes the culm to break at the infected area. Inter nodal infection also occurs at the base of the plant which causes white panicles similar to that induced by yellow stem borer or water deficit. Lesions on the neck are grayish brown and causes the girdling of the neck and the panicle to fall over",
        cure:
            "Carbendazim or Tricyclozole at 2 g/lit of water for 1 kg of seed. Soak the seeds in the solution for 2 h. Drain the solution, sprout the seeds and sow in the nursery bed. This wet seed treatment gives protection to the seedlings up to 40 days from seedling disease such as blast and this method is better than dry seed treatment",
        medicine: "Carbendazim",
    },
];
...
function getCure(disease) {
    for (let index = 0; index < treatment.length; index++) {
        if (treatment[index].disease == disease) {
            return treatment[index];
        }
    }
}

module.exports = { getCure };
